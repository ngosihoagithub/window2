...
namespace QuanLySieuThi
{
    class chuoiketnoi
    {
        public static string sqlcon = @"Data Source=NGOSIHOA\SQLEXPRESS;Initial Catalog=QLST;User ID=sa;Password=sa";
        ...
        internal static void Chuoiketnoi(object chuoi, DataGridView dta1)
        {
